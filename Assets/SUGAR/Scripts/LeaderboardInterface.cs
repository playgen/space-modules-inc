...
public class LeaderboardInterface : BaseLeaderboardInterface
{
	...
	protected override void Draw()
	{
		...
		_leaderboardName.text = SUGARManager.Leaderboard.CurrentLeaderboard != null ? Localization.Get(SUGARManager.Leaderboard.CurrentLeaderboard.Name.Replace(" ", "_")) : string.Empty;
