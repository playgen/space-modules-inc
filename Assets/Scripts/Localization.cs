...
public class Localization : MonoBehaviour {
    ...
    void Start()
    {
        ...
        if (text == null)
        {
            Debug.LogError("Localization script could not find Text component attached to this gameObject: " +
